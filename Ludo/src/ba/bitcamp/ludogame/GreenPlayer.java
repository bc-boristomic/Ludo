...
public class GreenPlayer extends JFrame {
	...
	static int[][] greenMove = new int[][] { { 0, 6 }, { 1, 6 }, { 2, 6 },
			{ 3, 6 }, { 4, 6 }, { 4, 7 }, { 4, 8 }, { 4, 9 }, { 4, 10 },
			{ 5, 10 }, { 6, 10 }, { 6, 9 }, { 6, 8 }, { 6, 7 }, { 6, 6 },
			{ 7, 6 }, { 8, 6 }, { 9, 6 }, { 10, 6 }, { 10, 5 }, { 10, 4 },
			{ 9, 4 }, { 8, 4 }, { 7, 4 }, { 6, 4 }, { 6, 3 }, { 6, 2 },
			{ 6, 1 }, { 6, 0 }, { 5, 0 }, { 4, 0 }, { 4, 1 }, { 4, 2 },
	...
	private class Action extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			...
			if (e.getSource() == label[x1][y1]) {
				if (label[x1][y1].getBackground().equals(Color.GREEN)) {
					if (temp1 >= 40 && temp1 < 43) {
						label[x1][y1].setBackground(new Color(179, 255, 179));
					} else if (temp1 == 43) {
					...
					if (temp1 + diceValue == temp2
						...
						label[x1][y1].setBackground(Color.GREEN);
					} else if (temp1 + diceValue < 44) {
						x1 = greenMove[temp1 + diceValue][0];
						y1 = greenMove[temp1 + diceValue][1];
						temp1 += diceValue;
						label[x1][y1].setBackground(Color.GREEN);
				...
				if (label[x2][y2].getBackground().equals(Color.GREEN)) {
					if (temp2 >= 40 && temp2 < 43) {
						label[x2][y2].setBackground(new Color(179, 255, 179));
					} else if (temp2 == 43) {
					...
					if (temp2 + diceValue == temp1
						...
						label[x2][y2].setBackground(Color.GREEN);
					} else if (temp2 + diceValue < 44) {
						x2 = greenMove[temp2 + diceValue][0];
						y2 = greenMove[temp2 + diceValue][1];
						temp2 += diceValue;
						label[x2][y2].setBackground(Color.GREEN);
				...
				if (label[x3][y3].getBackground().equals(Color.GREEN)) {
					if (temp3 >= 40 && temp3 < 43) {
						label[x3][y3].setBackground(new Color(179, 255, 179));
					} else if (temp3 == 43) {
					...
					if (temp3 + diceValue == temp1
						...
						label[x3][y3].setBackground(Color.GREEN);
					} else if (temp3 + diceValue < 44) {
						x3 = greenMove[temp3 + diceValue][0];
						y3 = greenMove[temp3 + diceValue][1];
						temp3 += diceValue;
						label[x3][y3].setBackground(Color.GREEN);
					} else {
						label[x3][y3].setBackground(Color.GREEN);
				...
				if (label[x4][y4].getBackground().equals(Color.GREEN)) {
					if (temp4 >= 40 && temp4 < 43) {
						label[x4][y4].setBackground(new Color(179, 255, 179));
					} else if (temp4 == 43) {
					...
					if (temp4 + diceValue == temp1
						...
						label[x4][y4].setBackground(Color.GREEN);
					} else if (temp4 + diceValue < 44) {
						x4 = greenMove[temp4 + diceValue][0];
						y4 = greenMove[temp4 + diceValue][1];
						temp4 += diceValue;
						label[x4][y4].setBackground(Color.GREEN);
