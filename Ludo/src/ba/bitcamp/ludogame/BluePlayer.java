...
public class BluePlayer extends JFrame {
	...
	private static int x1 = 6;
	private static int y1 = 10;

	private static int x2 = 6;
	private static int y2 = 10;

	private static int x3 = 6;
	private static int y3 = 10;

	private static int x4 = 6;
	private static int y4 = 10;
	...
	private class Action extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			...
			if (e.getSource() == label[x1][y1]) {
				if (label[x1][y1].getBackground().equals(Color.BLUE)) {
					if (temp1 >= 40 && temp1 < 43) {
						label[x1][y1].setBackground(new Color(179, 217, 255));
					} else if (temp1 == 43) {
					...
					if (temp1 + diceValue == temp2
						...
						label[x1][y1].setBackground(Color.BLUE);
					} else if (temp1 + diceValue < 44) {
						x1 = blueMove[temp1 + diceValue][0];
						y1 = blueMove[temp1 + diceValue][1];
						temp1 += diceValue;
						label[x1][y1].setBackground(Color.BLUE);
				...
				if (label[x2][y2].getBackground().equals(Color.BLUE)) {
					if (temp2 >= 40 && temp2 < 43) {
						label[x2][y2].setBackground(new Color(179, 217, 255));
					} else if (temp2 == 43) {
					...
					if (temp2 + diceValue == temp1
						...
						label[x2][y2].setBackground(Color.BLUE);
					} else if (temp2 + diceValue < 44) {
						x2 = blueMove[temp2 + diceValue][0];
						y2 = blueMove[temp2 + diceValue][1];
						temp2 += diceValue;
						label[x2][y2].setBackground(Color.BLUE);
				...
				if (label[x3][y3].getBackground().equals(Color.BLUE)) {
					if (temp3 >= 40 && temp3 < 43) {
						label[x3][y3].setBackground(new Color(179, 217, 255));
					} else if (temp3 == 43) {
					...
					if (temp3 + diceValue == temp1
						...
						label[x3][y3].setBackground(Color.BLUE);
					} else if (temp3 + diceValue < 44) {
						x3 = blueMove[temp3 + diceValue][0];
						y3 = blueMove[temp3 + diceValue][1];
						temp3 += diceValue;
						label[x3][y3].setBackground(Color.BLUE);
					} else {
						label[x3][y3].setBackground(Color.BLUE);
				...
				if (label[x4][y4].getBackground().equals(Color.BLUE)) {
					if (temp4 >= 40 && temp4 < 43) {
						label[x4][y4].setBackground(new Color(179, 217, 255));
					} else if (temp4 == 43) {
					...
					if (temp4 + diceValue == temp1
						...
						label[x4][y4].setBackground(Color.BLUE);
					} else if (temp4 + diceValue < 44) {
						x4 = blueMove[temp4 + diceValue][0];
						y4 = blueMove[temp4 + diceValue][1];
						temp4 += diceValue;
						label[x4][y4].setBackground(Color.BLUE);
