...
public class TryGreenPlayer extends JFrame {
	...
	private Pawn p1 = new Pawn(0, 6, Color.GREEN, new Color(179, 255, 179), 0);
	private Pawn p2 = new Pawn(0, 6, Color.GREEN, new Color(179, 255, 179), 0);
	private Pawn p3 = new Pawn(0, 6, Color.GREEN, new Color(179, 255, 179), 0);
	private Pawn p4 = new Pawn(0, 6, Color.GREEN, new Color(179, 255, 179), 0);
